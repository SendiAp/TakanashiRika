...
from Takanashirika import telethn as borg, HEROKU_APP_NAME, HEROKU_API_KEY, OWNER_ID, BOT_USERNAME
...
async def _(event):
    ...
    if event.sender_id == OWNER_ID:
        ...
        return
    await event.edit("**Restarted Takanashirika**")
    try:
