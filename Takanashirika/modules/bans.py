...
from Takanashirika import dispatcher, BAN_STICKER, KICK_STICKER, LOGGER, SUDO_USERS
from Takanashirika.modules.disable import DisableAbleCommandHandler
from Takanashirika.modules.helper_funcs.chat_status import bot_admin, user_admin, is_user_ban_protected, can_restrict, \
    is_user_admin, is_user_in_chat
from Takanashirika.modules.helper_funcs.extraction import extract_user_and_text
from Takanashirika.modules.helper_funcs.string_handling import extract_time
...
__help__ = """
 ...
 ✘ /banme: Jika Anda memberi perintah, Anda akan diinjak-injak dan dikunci! 

*Admin only:*
 ✘ /ban <userhandle> : melarang pengguna. (melalui pegangan, atau balasan)
 ✘ /sban <userhandle> : diam melarang pengguna. (melalui pegangan, atau balasan)
 ✘ /tban <userhandle> x(m/h/d) : melarang pengguna untuk x kali. (via handle, or reply). m = minutes, h = hours, d = days!
 ✘ /unban <userhandle> : membatalkan pemblokiran pengguna. (via handle, or reply)
 ✘ /kick <userhandle> : menendang pengguna, (via handle, or reply)
"""
