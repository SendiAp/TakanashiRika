...
import Takanashirika.modules.sql.notes_sql as sql
from Takanashirika import dispatcher, LOGGER, OWNER_ID, SUDO_USERS, MESSAGE_DUMP
from Takanashirika.__main__ import DATA_IMPORT
from Takanashirika.modules.helper_funcs.chat_status import user_admin
from Takanashirika.modules.helper_funcs.misc import build_keyboard, revert_buttons
from Takanashirika.modules.helper_funcs.msg_types import get_note_type
from Takanashirika.modules.rules import get_rules
import Takanashirika.modules.sql.rules_sql as rulessql
from Takanashirika.modules.sql import warns_sql as warnssql
import Takanashirika.modules.sql.blacklist_sql as blacklistsql
...
def export_data(bot: Bot, update: Update, chat_data):
    ...
    f=open("Takanashirika{}.backup".format(chat_id), "w")
    ...
    os.remove("Takanashirika{}.backup".format(chat_id)) # Cleaning file
...
*Hanya untuk administrator obrolan:*
 ✘ /import : balas file cadangan butler grup untuk diimpor sebanyak mungkin, membuat transfer menjadi sangat sederhana! Catatan \
bahwa file/foto tidak dapat diimpor karena pembatasan telegram!
 ✘ /export : export group data yang akan di export adalah : rules, notes (dokumen, gambar, musik, video, audio, suara, teks, tombol teks)
"""
