...
Command:
  ...
  ✘ /judge: sebagai balasan kepada seseorang, periksa apakah mereka berbohong atau tidak!
  ✘ /weebify: sebagai balasan sebuah pesan, "weebify" pesan tersebut.
  ✘ /shout <word>: teriakkan kata yang ditentukan dalam obrolan.
"""
