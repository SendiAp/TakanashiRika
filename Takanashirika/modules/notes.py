...
from Takanashirika import dispatcher, MESSAGE_DUMP, LOGGER
...
`buttonurl:` bagian, seperti: `[somelink](buttonurl:example.com)`. Check /markdownhelp untuk info lebih lanjut.
