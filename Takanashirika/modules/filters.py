...
*Admin only:*
 ✘  /filter <keyword> <reply message>: tambahkan filter ke obrolan ini. Bot sekarang akan membalas pesan itu setiap kali 'kata kunci'\ disebutkan. Jika Anda membalas stiker dengan kata kunci, bot akan membalas dengan stiker itu. 
CATATAN: semua filter \ kata kunci dalam huruf kecil. Jika Anda ingin kata kunci Anda menjadi kalimat, gunakan tanda kutip. misalnya: /filter "hey there" Bagaimana Anda \ lakukan?

 ✘  /stop <filter keyword>: hentikan filter itu.
 ✘  /stopall: hentikan semua filter.
"""
