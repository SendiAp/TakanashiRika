...
import Takanashirika.modules.sql.connection_sql as sql
from Takanashirika import dispatcher, SUDO_USERS, DEV_USERS, spamfilters
from Takanashirika.modules.helper_funcs import chat_status
...
from Takanashirika.modules.helper_funcs.alternate import send_message
...
__help__ = """
 ✘ /connect : sambungkan obrolan (Bisa dilakukan dalam grup by /connect or /connect <chat id> in PM)
