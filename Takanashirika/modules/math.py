...
__Mengingat__: Untuk menemukan garis singgung suatu fungsi pada nilai x tertentu, kirimkan permintaan sebagai c|f(x) 
di mana c adalah nilai x yang diberikan dan f(x) adalah ekspresi fungsi, pemisahnya adalah batang vertikal '|' . Lihat
""" 
